...
{
    //Pour forcer l'utilisateur à être connecté pour voir toutes les actions de ce Controller
    ...
    public class BookController : Controller
    {
        ...
        public BookController(IBookRepository<BLL.Entities.Book> bllService, RentSessionManager rentSession)
        {

...
GO
PRINT N'Création de Table [dbo].[UserProfile]...';
...
GO
PRINT N'Création de Contrainte par défaut contrainte sans nom sur [dbo].[UserProfile]...';
...
GO
PRINT N'Création de Contrainte de validation [dbo].[CK_UserProfile_ReadingSkill]...';
...
GO
PRINT N'Création de Contrainte de validation [dbo].[CK_UserProfile_DisabledDate]...';
...
CREATE TRIGGER [dbo].[TR_Book_Delete]
    ...
    END
GO
PRINT N'Création de Déclencheur [dbo].[TR_User_Delete]...';
...
CREATE TRIGGER [dbo].[TR_User_Delete]
    ...
    END
GO
PRINT N'Création de Déclencheur [dbo].[TR_UserProfile_Delete]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[SP_UserProfile_Delete]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[SP_UserProfile_Get_All]...';
...
AS
	...
	END
GO
PRINT N'Création de Procédure [dbo].[SP_UserProfile_Get_ById]...';
...
AS
	...
	END
GO
PRINT N'Création de Procédure [dbo].[SP_UserProfile_Insert]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[SP_UserProfile_Update]...';
...
EXEC [SP_Book_Insert] 
	...
	@author = N'Victor Dixen', 
	@isbn = '9782221202197'
EXEC SP_User_Insert @email = N'admin@admin', @password = N'Test1234='

EXEC SP_User_Insert @email = N'test@test', @password = N'Test1234='

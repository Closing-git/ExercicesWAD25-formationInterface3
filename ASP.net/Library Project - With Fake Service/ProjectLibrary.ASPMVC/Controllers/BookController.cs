...
namespace ProjectLibrary.ASPMVC.Controllers
{
    public class BookController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //Ne pas oublier d'ajouter model dans View()
            return View(model);
        }
        ...
        public ActionResult Create(CreateForm form)
        {
            try
            {
                ...
                //RedirectToAction : "action name", "Controller", routeValues (ici id) 
        ...
        public ActionResult Edit(Guid id, EditForm form)
        {
            try
            {
                ...
                //RedirectToAction : "action name", "Controller", routeValues (ici id) 
                return RedirectToAction(nameof(Details), "Book", new { id = id });
            }
            catch
            {
                return View();
